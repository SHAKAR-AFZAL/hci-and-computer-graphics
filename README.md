...
_Practical labs (Inlab & PostLab) exercises covering Human Computer Interaction (HCI) and Computer Graphics, focusing on the user centered design, usability, graphics programming, visualization, and algorithm implementation._
