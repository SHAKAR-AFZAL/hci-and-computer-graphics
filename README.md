...
_Practical labs (Inlab and PostLab) exercises covering Human Computer Interaction (HCI) and Computer Graphics, focusing on the user centered design, usability, graphics programming, visualization, and algorithm implementation._
...
This repository serves as a collection of my HCI and Computer Graphics labs work, demonstrating my understanding of user centered design, interactive systems, graphics programming, and computational problem solving through the practical exercises.
